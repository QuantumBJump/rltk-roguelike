...
impl BspDungeonBuilder {
    ...
    fn build(&mut self, rng: &mut RandomNumberGenerator, build_data: &mut BuilderMap) {
        ...
        // Up to 240 times, we get a random rectangle & divide it. If it is
        // possible to squeeze a room in there, we do so and add it to the
        // rooms list
        let mut n_rooms = 0;
        while n_rooms < 240 {
    ...
    fn get_random_sub_rect(&self, rect: Rect, rng: &mut RandomNumberGenerator) -> Rect {
        ...
        // Shunt room right/down 0-5 tiles
